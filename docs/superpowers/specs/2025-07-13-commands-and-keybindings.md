...
|---------|---------|-------|-------|------|---------|
| New | tab_new | New Tab | super+t | | exists |
| Close | tab_close | Close Tab | super+w | | exists |
| Next | tab_next | Next Tab | super+shift+] | | fix: cycle tabs not panes |
| Previous | tab_previous | Previous Tab | super+shift+[ | | fix: cycle tabs not panes |
| SelectIndex1 | tab_select_1 | Select Tab 1 | super+1 | | new |
| SelectIndex2 | tab_select_2 | Select Tab 2 | super+2 | | new |
| SelectIndex3 | tab_select_3 | Select Tab 3 | super+3 | | new |
| SelectIndex4 | tab_select_4 | Select Tab 4 | super+4 | | new |
| SelectIndex5 | tab_select_5 | Select Tab 5 | super+5 | | new |
| SelectIndex6 | tab_select_6 | Select Tab 6 | super+6 | | new |
| SelectIndex7 | tab_select_7 | Select Tab 7 | super+7 | | new |
| SelectIndex8 | tab_select_8 | Select Tab 8 | super+8 | | new |
| SelectLast | tab_select_last | Select Last Tab | super+9 | | new |
| Reopen | tab_reopen | Reopen Closed Tab | super+shift+t | | stub |
...
| Variant | menu id | label | accel | bind | Handler |
|---------|---------|-------|-------|------|---------|
| PrevPage | browser_prev_page | Back | super+[ | | exists |
| NextPage | browser_next_page | Forward | super+] | | exists |
| Reload | browser_reload | Reload | super+r | | exists |
| HardReload | browser_hard_reload | Hard Reload | super+shift+r | | stub |
| Stop | browser_stop | Stop Loading | | | stub |
| FocusAddressBar | browser_focus_address_bar | Open Location | super+l | | stub |
| Find | browser_find | Find | super+f | | stub |
| ZoomIn | browser_zoom_in | Zoom In | super+= | | stub |
| ZoomOut | browser_zoom_out | Zoom Out | super+- | | stub |
| ZoomReset | browser_zoom_reset | Actual Size | super+0 | | stub |
| DevTools | browser_dev_tools | Developer Tools | super+alt+i | | stub |
| ViewSource | browser_view_source | View Source | super+alt+u | | stub |
| Print | browser_print | Print | super+p | | stub |
...
| Next | next_space | Next Space | ctrl+tab | | stub |
| Previous | prev_space | Previous Space | ctrl+shift+tab | | stub |
...
| Variant | menu id | label | accel | bind | Handler |
|---------|---------|-------|-------|------|---------|
| NewWindow | new_window | New Window | super+n | | stub |
| CloseWindow | close_window | Close Window | super+shift+w | | stub |
| Minimize | minimize_window | Minimize | super+m | | stub |
| ToggleFullscreen | toggle_fullscreen | Toggle Fullscreen | ctrl+super+f | | stub |
| Settings | open_settings | Settings | super+, | | stub |
