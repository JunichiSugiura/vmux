...
mcp-command-description = Manage MCP servers
mcp-linear-description = Issues, projects, and teams
...
composer-choose-agent = Choose agent
composer-create-worktree = + Worktree
composer-create-worktree-title = Create or select a worktree for this project
composer-status-running = Running
composer-status-approval = Approval
composer-status-starting = Starting
composer-status-error = Error
composer-status-subagents = Active subagents
composer-status-tasks-title = Open plan tasks
composer-status-tasks = { $count } tasks
composer-status-queued-title = Queued prompts
composer-status-queued = { $count } queued
composer-uncommitted-changes = Uncommitted changes
composer-commits-ahead = Commits ahead of upstream
composer-no-git = No Git
composer-git = Git
...
command-partial-index = Only part of this project is indexed
command-more-matches = Showing {$shown} of {$total} matches
...
ex-quit = Close without saving
ex-quit-force = Close and discard changes
ex-nohighlight = Clear the search highlight
ex-delete = Delete the line
ex-yank = Yank the line
ex-substitute = Substitute in the line
...
command-browser-open-goto-line = Browser > Bar > Go to Line
command-browser-open-indentation = Browser > Bar > Select Indentation
command-browser-open-line-ending = Browser > Bar > Select End of Line Sequence
command-browser-open-encoding = Browser > Bar > Select Encoding
command-browser-open-reopen-with-encoding = Browser > Bar > Reopen with Encoding
command-browser-open-save-with-encoding = Browser > Bar > Save with Encoding
...
agent-option-default = { $value } (default)
agent-tool-calling = Calling tool
...
editor-status-goto-title = Go to Line
editor-status-goto-placeholder = Line number
editor-status-pick-placeholder = Type to filter
editor-status-indent-title = Select Indentation
editor-status-eol-title = Select End of Line Sequence
editor-status-encoding-title = Select Encoding
editor-status-encoding-reopen = Reopen with Encoding
editor-status-encoding-save = Save with Encoding
...
editor-find-case = Match case
editor-find-in-files-placeholder = Search in files
editor-find-whole-word = Match whole word
editor-search = Search
editor-search-clear = Clear search results
editor-search-idle = Press Enter to search
editor-search-summary = { $results } results in { $files } files
editor-search-summary-capped = Showing the first { $results } results in { $files } files
editor-show-explorer = Show explorer
editor-show-search = Show search
...
editor-explorer-empty = No files
editor-open-editors = Open Editors
editor-close-editor = Close editor
editor-outline = Outline
editor-close-directory = Close the directory
editor-breadcrumb = Breadcrumbs
editor-breadcrumb-hidden = Show hidden folders
editor-breadcrumb-empty = Nothing here
...
resume-column-updated = Updated
resume-age-now = now
resume-age-minutes = { $count }m
resume-age-hours = { $count }h
resume-age-days = { $count }d
resume-age-weeks = { $count }w
resume-age-months = { $count }mo
resume-age-years = { $count }y
