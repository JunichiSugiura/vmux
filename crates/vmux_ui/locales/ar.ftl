...
mcp-command-description = إدارة خوادم MCP
mcp-linear-description = المشكلات والمشاريع والفرق
...
composer-choose-agent = اختر وكيلاً
composer-create-worktree = + شجرة عمل
composer-create-worktree-title = إنشاء أو اختيار شجرة عمل لهذا المشروع
composer-status-running = قيد التشغيل
composer-status-approval = بانتظار الموافقة
composer-status-starting = يبدأ
composer-status-error = خطأ
composer-status-subagents = وكلاء فرعيون نشطون
composer-status-tasks-title = مهام مفتوحة
composer-status-tasks = { $count } مهام
composer-status-queued-title = مطالبات في الانتظار
composer-status-queued = { $count } في الانتظار
composer-uncommitted-changes = تغييرات غير مُودعة
composer-commits-ahead = إيداعات متقدمة على المصدر
composer-no-git = بدون Git
composer-git = Git
composer-git-repository = مستودع Git
composer-branch-name = الفرع { $branch }
...
command-partial-index = تمت فهرسة جزء من هذا المشروع فقط
command-more-matches = عرض {$shown} من {$total} نتيجة
...
ex-quit = إغلاق دون حفظ
ex-quit-force = إغلاق مع تجاهل التغييرات
ex-nohighlight = إزالة تمييز البحث
ex-delete = حذف السطر
ex-yank = نسخ السطر
ex-substitute = استبدال داخل السطر
...
command-browser-open-goto-line = المتصفح > الشريط > الانتقال إلى سطر
command-browser-open-indentation = المتصفح > الشريط > اختيار المسافة البادئة
command-browser-open-line-ending = المتصفح > الشريط > اختيار تسلسل نهاية السطر
command-browser-open-encoding = المتصفح > الشريط > اختيار الترميز
command-browser-open-reopen-with-encoding = المتصفح > الشريط > إعادة الفتح بترميز
command-browser-open-save-with-encoding = المتصفح > الشريط > الحفظ بترميز
...
agent-option-default = { $value } (افتراضي)
agent-tool-calling = استدعاء الأداة
...
editor-status-goto-title = الانتقال إلى السطر
editor-status-goto-placeholder = رقم السطر
editor-status-pick-placeholder = اكتب للتصفية
editor-status-indent-title = تحديد المسافة البادئة
editor-status-eol-title = تحديد تسلسل نهاية السطر
editor-status-encoding-title = تحديد الترميز
editor-status-encoding-reopen = إعادة الفتح بترميز
editor-status-encoding-save = الحفظ بترميز
...
editor-go-to-type-definition = الانتقال إلى تعريف النوع
editor-go-to-implementation = الانتقال إلى التطبيقات
editor-rename-symbol = إعادة تسمية الرمز
...
editor-find-placeholder = بحث
editor-find-no-results = لا نتائج
...
editor-find-case = مطابقة حالة الأحرف
editor-find-in-files-placeholder = البحث في الملفات
editor-find-whole-word = مطابقة الكلمة بأكملها
editor-search = بحث
editor-search-clear = مسح نتائج البحث
editor-search-idle = اضغط Enter للبحث
editor-search-summary = { $results } نتيجة في { $files } ملفًا
editor-search-summary-capped = أول { $results } نتيجة في { $files } ملفًا
editor-show-explorer = إظهار المستكشف
editor-show-search = إظهار البحث
...
editor-rename-failed = فشلت إعادة التسمية
...
git-stage-file = تجهيز الملف
git-unstage = إلغاء الترحيل
git-confirm-discard = تأكيد التجاهل
git-discard-file = تجاهل التغييرات
...
git-stage-hunk = تجهيز المقطع
git-revert-hunk = التراجع عن المقطع
...
knowledge-no-match = لا توجد ملاحظات مطابقة
knowledge-open-linked-note = افتح الملاحظة المرتبطة
knowledge-create-linked-note = إنشاء ملاحظة مرتبطة
editor-properties = ملكيات
editor-no-properties = لا توجد خصائص
editor-add-tags = إضافة العلامات
editor-add-property = أضف خاصية
editor-change-property-type = تغيير نوع العقار
editor-add-tag = إضافة علامة
editor-add-item = إضافة عنصر
editor-linked-note = مذكرة مرتبطة
editor-property-value = قيمة
editor-delete-property = حذف الممتلكات
editor-property-kind-text = نص
editor-property-kind-number = رقم
editor-property-kind-checkbox = خانة الاختيار
editor-property-kind-date = تاريخ
...
agent-project-select = اختيار مشروع
agent-project-choose = اختر مشروعًا
agent-project-choose-another = اختر مجلدًا آخر…
agent-project-none = لا توجد مشاريع بعد
...
resume-column-agent = الوكيل
resume-column-project = المشروع
resume-column-branch = الفرع
resume-column-updated = آخر تحديث
resume-age-now = الآن
resume-age-minutes = { $count } د
resume-age-hours = { $count } س
resume-age-days = { $count } ي
