...
mod wasm {
    ...
    pub fn BuiltinIconView(icon: BuiltinIcon, class: String) -> Element {
        match icon {
            ...
            BuiltinIcon::Brain => rsx! { Icon { class: "{class}",
                path { d: "M9.5 4.5a3.2 3.2 0 0 1 5.35 1.05 3.35 3.35 0 0 1 2.8 3.35 3.5 3.5 0 0 1 .55 6.45A3.4 3.4 0 0 1 15 18.5H9a4 4 0 0 1-3.75-5.4 3.5 3.5 0 0 1 1.2-6.3A3.2 3.2 0 0 1 9.5 4.5Z" }
                path { d: "M14.5 18.5c0 1.4.9 2.5 2.5 2.5v-4.4" }
                path { d: "M9.4 4.7c-.9 1.2-.8 2.8.3 3.8" }
                path { d: "M6.2 9.4c1.3-.7 2.8-.4 3.8.6" }
                path { d: "M13.9 5.8c-.7 1-.6 2.2.2 3.1" }
                path { d: "M14.1 9c1.4-.2 2.6.6 3.1 1.7" }
                path { d: "M8.5 13.2c1-.7 2.4-.5 3.2.4" }
                path { d: "M12.6 11.9c-.1 1.9.8 3.6 2.4 4.4" }
            } },
            ...
            BuiltinIcon::Keyboard => rsx! { Icon { class: "{class}",
