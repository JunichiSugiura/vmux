...
tools-search = Пошук пакетів, агентів, MCP, LSP і файлів конфігурації…
...
tools-provider-lsp-servers = Сервери LSP
tools-provider-mcp-servers = Сервери MCP
mcp-command-description = Керування серверами MCP
mcp-linear-description = Завдання, проєкти й команди
...
vault-recovery-key-create-failed = Не вдалося створити ключ відновлення.
vault-recovery-key-save = Збережіть цей ключ зараз. Vmux не може показати це знову.
vault-recovery-key-saved = Я зберіг його
vault-recovery-key-placeholder = Вставте ключ відновлення
vault-recovery-key-unlock = Розблокувати
vault-recovery-key-invalid = Цей ключ відновлення не може розблокувати сховище.
vault-recovery-key-ready = Ключ відновлення налаштовано
vault-recovery-key-upload-pending = Ключ збережено локально, але завантажити не вдалося. Збережіть його та натисніть «Синхронізувати», щоб повторити спробу.
vault-auto-sync = Автоматичне резервне копіювання
vault-backup-failed = Помилка автоматичного резервного копіювання. Натисніть «Синхронізувати», щоб повторити спробу.
vault-backup-failed-short = Помилка резервного копіювання
vault-recovery-key-copy-hint = Натисніть, щоб скопіювати
vault-recovery-key-copied = Скопійовано
vault-recovery-key-verify = Збережіть його в менеджері паролів, а потім вставте нижче, щоб перевірити.
vault-recovery-key-verify-placeholder = Вставте збережений ключ відновлення
vault-recovery-key-mismatch = Ключ відновлення не збігається.
...
vault-connect = Підключитися
vault-github = GitHub
vault-github-description = Створіть приватне сховище або виберіть наявне сховище.
vault-connect-github = Підключіть GitHub
vault-connected-as = Підключено як { $name }
vault-use-repository = використання
vault-repository-name = Назва сховища
vault-cloud-folder = Хмарна папка
vault-cloud-folder-description = Використовуйте папку з Google Drive, iCloud Drive, Dropbox або OneDrive.
vault-choose-folder = Виберіть папку
vault-result-github-connected = GitHub · { common-done }
vault-result-folder-connected = Папка · { common-done }
vault-private = Приватне сховище
vault-public-warning = Історія репозиторію та зашифровані дані будуть загальнодоступними.
vault-choose-repository = Виберіть сховище…
vault-empty = порожній
vault-clean = В актуальному стані
vault-not-connected = Не підключено
vault-change-count = Зміни: { $count }
...
simulator-keyboard = Клавіатура
simulator-keyboard-placeholder = Введіть або вставте текст на iPhone
simulator-copy = Копіювати
simulator-paste = Вставити
...
composer-project = Проєкт
composer-branch = Гілка
...
composer-status-running = Виконується
composer-status-approval = Підтвердження
composer-status-starting = Запуск
composer-status-error = Помилка
composer-status-subagents = Активні субагенти
composer-status-tasks-title = Відкриті завдання
composer-status-tasks = Завдань: { $count }
composer-status-queued-title = Промпти в черзі
composer-status-queued = У черзі: { $count }
composer-uncommitted-changes = Незафіксовані зміни
composer-commits-ahead = Коміти попереду upstream
composer-no-git = Без Git
composer-git = Git
composer-git-repository = Репозиторій Git
composer-branch-name = Гілка { $branch }
...
command-partial-index = Проіндексовано лише частину цього проєкту
command-more-matches = Показано {$shown} з {$total} збігів
command-placeholder = Введіть URL, шукайте вкладки або > для команд…
command-ex-placeholder = Введіть команду Ex…
palette-mode-ex = Ex
palette-mode-command = Команди
palette-mode-slash = Команда
palette-mode-path = Файли
ex-write = Зберегти файл
ex-write-quit = Зберегти й закрити
ex-quit = Закрити без збереження
ex-quit-force = Закрити й відхилити зміни
ex-nohighlight = Зняти підсвічування пошуку
ex-delete = Видалити рядок
ex-yank = Скопіювати рядок
ex-substitute = Замінити в рядку
...
command-open-editor = Відкрити в редакторі
command-stack = Стек
command-tabs = { $count ->
    [one] 1 вкладка
   *[other] { $count } вкладок
...
layout-project-forget = Забути цей проєкт
layout-project-activate = Відкривати нові вкладки тут
...
common-collapse-all = Згорнути все
...
command-browser-open-goto-line = Браузер > Панель > Перейти до рядка
command-browser-open-indentation = Браузер > Панель > Вибрати відступ
command-browser-open-line-ending = Браузер > Панель > Вибрати кінець рядка
command-browser-open-encoding = Браузер > Панель > Вибрати кодування
command-browser-open-reopen-with-encoding = Браузер > Панель > Відкрити знову в кодуванні
command-browser-open-save-with-encoding = Браузер > Панель > Зберегти в кодуванні
...
agent-change-model = Змінити модель
...
agent-option-default = { $value } (за умовчанням)
agent-tool-calling = Виклик інструмента
...
editor-status-goto-title = Перейти до рядка
editor-status-goto-placeholder = Номер рядка
editor-status-pick-placeholder = Введіть для фільтрації
editor-status-indent-title = Вибрати відступ
editor-status-eol-title = Вибрати символ кінця рядка
editor-status-encoding-title = Вибрати кодування
editor-status-encoding-reopen = Повторно відкрити в кодуванні
editor-status-encoding-save = Зберегти в кодуванні
...
editor-go-to-type-definition = Перейти до визначення типу
editor-go-to-implementation = Перейти до реалізацій
editor-rename-symbol = Перейменувати символ
editor-change-all-occurrences = Змінити всі входження
editor-format-document = Форматувати документ
editor-format-selection = Форматувати виділення
editor-code-action = Рефакторинг…
editor-cut = Вирізати
editor-copy = Копіювати
editor-paste = Вставити
editor-command-palette = Палітра команд…
editor-unsaved = не збережено
editor-find-placeholder = Пошук
editor-find-no-results = Немає збігів
...
editor-find-case = Враховувати регістр
editor-find-in-files-placeholder = Пошук у файлах
editor-find-whole-word = Слово цілком
editor-search = Пошук
editor-search-clear = Очистити результати пошуку
editor-search-idle = Натисніть Enter для пошуку
editor-search-summary = Результатів: { $results } у { $files } файлах
editor-search-summary-capped = Перші { $results } результатів у { $files } файлах
editor-show-explorer = Показати провідник
editor-show-search = Показати пошук
...
git-stage-file = Додати файл до індексу
git-unstage = Прибрати з індексу
git-confirm-discard = Підтвердити скасування
git-discard-file = Скасувати зміни
...
git-stage-hunk = Додати блок до індексу
git-revert-hunk = Відкотити блок
...
knowledge-search = Знання пошуку
knowledge-no-match = Немає відповідних нотаток
knowledge-open-linked-note = Відкрити пов’язану нотатку
knowledge-create-linked-note = Створити пов’язану нотатку
editor-properties = Властивості
editor-no-properties = Немає властивостей
editor-add-tags = Додайте теги
editor-add-property = Додати властивість
editor-change-property-type = Змінити тип власності
editor-add-tag = Додати тег
editor-add-item = Додати товар
editor-linked-note = Пов’язана примітка
editor-property-value = Значення
editor-delete-property = Видалити властивість
editor-property-kind-text = текст
editor-property-kind-number = Номер
editor-property-kind-checkbox = Прапорець
editor-property-kind-date = Дата
...
mobile-pair-title = Підключіться до свого Mac
mobile-pair-subtitle = У Vmux відкрийте Remote і виберіть Connect device.
mobile-pair-scan = Сканувати QR-код
mobile-pair-show-link = Ввести посилання вручну
mobile-pair-hide-link = Сховати посилання
mobile-pair-link-placeholder = Вставте посилання для сполучення
mobile-pair-connect = Підключитися
mobile-pair-connecting = Підключення…
mobile-pair-disconnect = Відключитися
mobile-status-connected = Під’єднано
mobile-status-reaching = Встановлюємо зв’язок із вашим Mac…
mobile-status-disconnected = Не під’єднано

mobile-url-invalid = Недійсний URL для сполучення.
mobile-url-no-address = У URL для сполучення немає адреси сервера.
mobile-url-bad-address = У URL для сполучення хибна адреса сервера.
mobile-url-no-token = У URL для сполучення немає токена.
mobile-url-scheme = URL для сполучення має використовувати HTTPS або HTTP.
mobile-url-paste-full = Вставте повний URL для сполучення, який Vmux показує на вашому Mac.

mobile-error-pairing-outdated = Це сполучення застаріло. Відскануйте QR-код на Mac ще раз.
mobile-error-pairing-expired = Термін сполучення минув. Відскануйте QR-код на Mac ще раз.
mobile-error-pairing-lost = Термін сполучення минув. Виконайте сполучення з Mac ще раз.
mobile-error-token-rejected = Токен сполучення відхилено.
mobile-error-stack-missing = Комп’ютер відкрив чат, але його стек не з’явився.
mobile-error-not-offered = Ваш Mac поки цього не пропонує.
mobile-error-remote-disabled = На вашому Mac Remote вимкнено.
mobile-error-session-gone = Цього сеансу вже немає.
mobile-error-no-desktop = Відкрийте вікно Vmux на своєму Mac.
mobile-error-refused = Ваш Mac не зміг це зробити.
mobile-error-no-answer = Немає відповіді від { $address } через { $seconds } с.
...
mobile-chat-back-to-stacks = Назад до стеків
mobile-chat-no-messages = Повідомлень ще немає.
mobile-chat-no-session = Немає активного сеансу
mobile-chat-placeholder = Написати агенту…
mobile-chat-send = Надіслати
mobile-chat-stop = Зупинити

mobile-qr-title = Відскануйте QR-код, який показує Vmux
mobile-qr-cancel = Скасувати
mobile-qr-unavailable = Сканер QR недоступний.
mobile-qr-camera-unavailable = Камера недоступна. Введіть посилання для сполучення.
mobile-qr-camera-failed = Не вдалося відкрити камеру: { $error }
mobile-qr-camera-input-unavailable = Вхід камери недоступний.
mobile-qr-unsupported-device = Сканування QR недоступне на цьому пристрої.
mobile-qr-unsupported-platform = Сканування QR ще недоступне на цій платформі. Введіть посилання для сполучення.
mobile-error-unexpected-answer = Ваш Mac відповів несподівано.
mobile-error-connection-dropped = З’єднання з вашим Mac розірвалося.
...
agent-project-select = Вибрати проєкт
agent-project-choose = Вибір проєкту
agent-project-choose-another = Вибрати іншу теку…
agent-project-none = Проєктів ще немає
...
resume-column-agent = Агент
resume-column-project = Проєкт
resume-column-branch = Гілка
resume-column-updated = Оновлено
resume-age-now = щойно
resume-age-minutes = { $count } хв
resume-age-hours = { $count } год
resume-age-days = { $count } д
resume-age-weeks = { $count } тиж
resume-age-months = { $count } міс
resume-age-years = { $count } р
