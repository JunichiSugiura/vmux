...
mcp-command-description = Gestionar servidores MCP
mcp-linear-description = Incidencias, proyectos y equipos
...
team-profiles = Perfiles
team-new-profile = Nuevo perfil
team-switch-profile = Cambiar a { $profile }
team-edit-profile = Editar perfil
team-profile-name = Nombre del perfil
...
composer-status-running = En curso
composer-status-approval = Aprobación
composer-status-starting = Iniciando
composer-status-error = Error
composer-status-subagents = Subagentes activos
composer-status-tasks-title = Tareas abiertas
composer-status-tasks = { $count } tareas
composer-status-queued-title = Prompts en cola
composer-status-queued = { $count } en cola
...
composer-git = Git
composer-git-repository = Repositorio Git
composer-branch-name = Rama { $branch }
...
command-partial-index = Solo se ha indexado parte de este proyecto
command-more-matches = Mostrando {$shown} de {$total} coincidencias
command-placeholder = Escribe una URL, busca pestañas o usa > para comandos…
command-ex-placeholder = Escribe un comando Ex…
palette-mode-ex = Ex
palette-mode-command = Comandos
palette-mode-slash = Comando
palette-mode-path = Archivos
ex-write = Guardar el archivo
ex-write-quit = Guardar y cerrar
ex-quit = Cerrar sin guardar
ex-quit-force = Cerrar y descartar los cambios
ex-nohighlight = Quitar el resaltado de búsqueda
ex-delete = Eliminar la línea
ex-yank = Copiar la línea
ex-substitute = Sustituir en la línea
...
common-collapse-all = Contraer todo
...
command-browser-open-goto-line = Navegador > Barra > Ir a la línea
command-browser-open-indentation = Navegador > Barra > Seleccionar sangría
command-browser-open-line-ending = Navegador > Barra > Seleccionar fin de línea
command-browser-open-encoding = Navegador > Barra > Seleccionar codificación
command-browser-open-reopen-with-encoding = Navegador > Barra > Reabrir con codificación
command-browser-open-save-with-encoding = Navegador > Barra > Guardar con codificación
...
agent-option-default = { $value } (predeterminado)
agent-tool-calling = Llamando a la herramienta
...
editor-status-goto-title = Ir a la línea
editor-status-goto-placeholder = Número de línea
editor-status-pick-placeholder = Escribe para filtrar
editor-status-indent-title = Seleccionar sangría
editor-status-eol-title = Seleccionar secuencia de fin de línea
editor-status-encoding-title = Seleccionar codificación
editor-status-encoding-reopen = Volver a abrir con codificación
editor-status-encoding-save = Guardar con codificación
...
editor-find-case = Coincidir mayúsculas y minúsculas
editor-find-in-files-placeholder = Buscar en archivos
editor-find-whole-word = Palabra completa
editor-search = Buscar
editor-search-clear = Borrar resultados de búsqueda
editor-search-idle = Pulsa Intro para buscar
editor-search-summary = { $results } resultados en { $files } archivos
editor-search-summary-capped = Primeros { $results } resultados en { $files } archivos
editor-show-explorer = Mostrar explorador
editor-show-search = Mostrar búsqueda
...
editor-explorer-empty = Sin archivos
editor-open-editors = Editores abiertos
editor-close-editor = Cerrar editor
editor-outline = Esquema
editor-close-directory = Cerrar el directorio
editor-breadcrumb = Ruta de navegación
editor-breadcrumb-hidden = Mostrar carpetas ocultas
editor-breadcrumb-empty = No hay nada aquí
...
editor-rename-failed = Error al cambiar el nombre
...
resume-column-project = Proyecto
resume-column-branch = Rama
resume-column-updated = Actualizado
resume-age-now = ahora
