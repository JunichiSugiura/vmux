            ...
            TabCommand::New => {
                ...
                if is_terminal {
                    let tab = commands
                        ...
                        .id();
                    commands.entity(tab).insert(vmux_core::PageMetadata {
                        url: TERMINAL_WEBVIEW_URL.to_string(),
                        title: "Terminal".to_string(),
                        ..default()
                    });
                    spawn_requests.write(LayoutSpawnRequest::Terminal { tab });
                    ...
                    spawn_requests.write(LayoutSpawnRequest::ProcessesMonitor { tab });
                } else {
...
pub fn open_command_bar_if_no_tabs(
    spaces: Query<(Entity, &LastActivatedAt), With<Space>>,
    all_children: Query<&Children>,
    leaf_panes: Query<Entity, (With<Pane>, Without<PaneSplit>)>,
    pane_ts: Query<(Entity, &LastActivatedAt), With<Pane>>,
