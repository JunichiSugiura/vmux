...
mcp-command-description = Управление серверами MCP
mcp-linear-description = Задачи, проекты и команды
...
shortcuts-count = Сочетаний: { $count }
shortcuts-search = Фильтр сочетаний…
shortcuts-empty = Нет подходящих сочетаний
shortcuts-general = Общие
shortcuts-try-title = Проверить сочетание
shortcuts-try-hint = Нажмите любое сочетание клавиш
shortcuts-waiting = Ожидание следующей клавиши…
shortcuts-triggered = Выполняет: { $action }
shortcuts-no-match = Нет сочетания для этих клавиш
shortcuts-clear = Сбросить

team-title = Команда
simulator-title = Симулятор
simulator-waiting-device = { $device } · iOS { $version }
simulator-waiting-version = iOS { $version }
team-profiles = Профили
team-new-profile = Новый профиль
team-switch-profile = Переключиться на { $profile }
team-edit-profile = Изменить профиль
team-profile-name = Имя профиля
...
composer-branch = Ветка
composer-attach-files = Прикрепить файлы (/upload)
composer-remove-attachment = Удалить вложение
composer-choose-agent = Выбрать агента
composer-create-worktree = + Worktree
composer-create-worktree-title = Создать или выбрать рабочее дерево для этого проекта
composer-status-running = Выполняется
composer-status-approval = Подтверждение
composer-status-starting = Запуск
composer-status-error = Ошибка
composer-status-subagents = Активные субагенты
composer-status-tasks-title = Открытые задачи
composer-status-tasks = Задач: { $count }
composer-status-queued-title = Промпты в очереди
composer-status-queued = В очереди: { $count }
composer-uncommitted-changes = Незафиксированные изменения
composer-commits-ahead = Коммиты впереди upstream
composer-no-git = Без Git
composer-git = Git
composer-git-repository = Репозиторий Git
composer-branch-name = Ветка { $branch }
...
command-partial-index = Проиндексирована только часть этого проекта
command-more-matches = Показано {$shown} из {$total} совпадений
...
ex-quit = Закрыть без сохранения
ex-quit-force = Закрыть и отменить изменения
ex-nohighlight = Снять подсветку поиска
ex-delete = Удалить строку
ex-yank = Скопировать строку
ex-substitute = Заменить в строке
...
layout-project-activate = Открывать новые вкладки здесь
...
command-browser-open-goto-line = Браузер > Панель > Перейти к строке
command-browser-open-indentation = Браузер > Панель > Выбрать отступ
command-browser-open-line-ending = Браузер > Панель > Выбрать конец строки
command-browser-open-encoding = Браузер > Панель > Выбрать кодировку
command-browser-open-reopen-with-encoding = Браузер > Панель > Открыть заново в кодировке
command-browser-open-save-with-encoding = Браузер > Панель > Сохранить в кодировке
...
agent-option-default = { $value } (по умолчанию)
agent-tool-calling = Вызов инструмента
...
editor-status-goto-title = Перейти к строке
editor-status-goto-placeholder = Номер строки
editor-status-pick-placeholder = Введите для фильтрации
editor-status-indent-title = Выбрать отступ
editor-status-eol-title = Выбрать символ конца строки
editor-status-encoding-title = Выбрать кодировку
editor-status-encoding-reopen = Снова открыть в кодировке
editor-status-encoding-save = Сохранить в кодировке
...
editor-go-to-type-definition = Перейти к определению типа
editor-go-to-implementation = Перейти к реализациям
editor-rename-symbol = Переименовать символ
editor-change-all-occurrences = Изменить все вхождения
editor-format-document = Форматировать документ
editor-format-selection = Форматировать выделение
editor-code-action = Рефакторинг…
editor-cut = Вырезать
editor-copy = Копировать
editor-paste = Вставить
editor-command-palette = Палитра команд…
editor-unsaved = не сохранено
editor-find-placeholder = Поиск
editor-find-no-results = Нет совпадений
...
editor-find-case = Учитывать регистр
editor-find-in-files-placeholder = Поиск в файлах
editor-find-whole-word = Слово целиком
editor-search = Поиск
editor-search-clear = Очистить результаты поиска
editor-search-idle = Нажмите Enter для поиска
editor-search-summary = Результатов: { $results } в { $files } файлах
editor-search-summary-capped = Первые { $results } результатов в { $files } файлах
editor-show-explorer = Показать проводник
editor-show-search = Показать поиск
...
editor-explorer-empty = Нет файлов
editor-open-editors = Открытые редакторы
editor-close-editor = Закрыть редактор
editor-outline = Структура
editor-close-directory = Закрыть каталог
editor-breadcrumb = Навигационная цепочка
editor-breadcrumb-hidden = Показать скрытые папки
editor-breadcrumb-empty = Здесь ничего нет
...
git-stage-file = Добавить файл в индекс
git-unstage = Убрать из индекса
git-confirm-discard = Подтвердить отмену
git-discard-file = Отменить изменения
...
git-stage-hunk = Добавить блок в индекс
git-revert-hunk = Откатить блок
...
knowledge-search = Поиск знаний
knowledge-no-match = Нет подходящих заметок
knowledge-open-linked-note = Открыть связанную заметку
knowledge-create-linked-note = Создать связанную заметку
editor-properties = Характеристики
editor-no-properties = Нет свойств
editor-add-tags = Добавить теги
editor-add-property = Добавить недвижимость
editor-change-property-type = Изменить тип недвижимости
editor-add-tag = Добавить тег
editor-add-item = Добавить элемент
editor-linked-note = Связанная заметка
editor-property-value = Ценить
editor-delete-property = Удалить свойство
editor-property-kind-text = Текст
editor-property-kind-number = Число
editor-property-kind-checkbox = Флажок
...
mobile-pair-title = Подключитесь к своему Mac
mobile-pair-subtitle = В Vmux откройте Remote и выберите Connect device.
mobile-pair-scan = Сканировать QR-код
mobile-pair-show-link = Ввести ссылку сопряжения вручную
mobile-pair-hide-link = Скрыть ссылку сопряжения
mobile-pair-link-placeholder = Вставьте ссылку сопряжения
mobile-pair-connect = Подключиться
mobile-pair-connecting = Подключение…
mobile-pair-disconnect = Отключиться
mobile-status-connected = Подключено
mobile-status-reaching = Ищем ваш Mac…
mobile-status-disconnected = Не подключено

mobile-url-invalid = Ссылка сопряжения недействительна.
mobile-url-no-address = В ссылке сопряжения нет адреса сервера.
mobile-url-bad-address = В ссылке сопряжения указан неверный адрес сервера.
mobile-url-no-token = В ссылке сопряжения нет токена.
mobile-url-scheme = Ссылка сопряжения должна использовать HTTPS или HTTP.
mobile-url-paste-full = Вставьте полную ссылку сопряжения, показанную Vmux на вашем Mac.

mobile-error-pairing-outdated = Это сопряжение устарело. Отсканируйте QR на вашем Mac ещё раз.
mobile-error-pairing-expired = Срок сопряжения истёк. Отсканируйте QR на вашем Mac ещё раз.
mobile-error-pairing-lost = Срок сопряжения истёк. Выполните сопряжение с Mac заново.
mobile-error-token-rejected = Токен сопряжения отклонён.
mobile-error-stack-missing = На компьютере чат открылся, но его стек не появился.
mobile-error-not-offered = Ваш Mac пока этого не предлагает.
mobile-error-remote-disabled = Remote выключен на вашем Mac.
mobile-error-session-gone = Этой сессии больше нет.
mobile-error-no-desktop = Откройте окно Vmux на своём Mac.
mobile-error-refused = Ваш Mac не смог это сделать.
mobile-error-no-answer = Нет ответа от { $address } через { $seconds } с.

mobile-start-stacks = Стеки
mobile-start-no-stacks = Нет открытых стеков
mobile-start-team = Команда
mobile-start-tab-location = { $runtime } · { $cwd }
mobile-start-search-placeholder = Найти или спросить…
mobile-start-new-chat = Начать чат
mobile-start-starting = Запуск…

mobile-chat-back = Назад
mobile-chat-back-to-stacks = К стекам
mobile-chat-no-messages = Сообщений пока нет.
mobile-chat-no-session = Нет активной сессии
mobile-chat-placeholder = Сообщение агенту…
mobile-chat-send = Отправить
mobile-chat-stop = Остановить

mobile-qr-title = Отсканируйте QR-код, показанный Vmux
mobile-qr-cancel = Отмена
mobile-qr-unavailable = Сканер QR-кодов недоступен.
mobile-qr-camera-unavailable = Камера недоступна. Введите ссылку сопряжения вручную.
mobile-qr-camera-failed = Не удалось открыть камеру: { $error }
mobile-qr-camera-input-unavailable = Вход камеры недоступен.
mobile-qr-unsupported-device = Сканирование QR-кодов недоступно на этом устройстве.
mobile-qr-unsupported-platform = Сканирование QR-кодов пока недоступно на этой платформе. Введите ссылку сопряжения вручную.
mobile-error-unexpected-answer = Ваш Mac ответил неожиданно.
mobile-error-connection-dropped = Соединение с вашим Mac разорвано.
...
agent-project-select = Выбрать проект
agent-project-choose = Выбор проекта
agent-project-choose-another = Выбрать другую папку…
agent-project-none = Проектов пока нет
...
resume-column-project = Проект
resume-column-branch = Ветка
resume-column-updated = Обновлено
resume-age-now = сейчас
resume-age-minutes = { $count } мин
resume-age-hours = { $count } ч
resume-age-days = { $count } д
resume-age-weeks = { $count } нед
resume-age-months = { $count } мес
resume-age-years = { $count } г
