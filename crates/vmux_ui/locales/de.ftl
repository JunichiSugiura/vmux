...
mcp-command-description = MCP-Server verwalten
mcp-linear-description = Vorgänge, Projekte und Teams
...
composer-choose-agent = Agent auswählen
composer-create-worktree = + Worktree
composer-create-worktree-title = Worktree für dieses Projekt erstellen oder auswählen
composer-status-running = Läuft
composer-status-approval = Freigabe
composer-status-starting = Startet
composer-status-error = Fehler
composer-status-subagents = Aktive Subagenten
composer-status-tasks-title = Offene Aufgaben
composer-status-tasks = { $count } Aufgaben
composer-status-queued-title = Wartende Prompts
composer-status-queued = { $count } in Warteschlange
composer-uncommitted-changes = Nicht committete Änderungen
composer-commits-ahead = Commits vor dem Upstream
composer-no-git = Kein Git
composer-git = Git
composer-git-repository = Git-Repository
composer-branch-name = Branch { $branch }
...
command-partial-index = Nur ein Teil dieses Projekts ist indexiert
command-more-matches = {$shown} von {$total} Treffern werden angezeigt
command-placeholder = URL eingeben, Tabs suchen oder > für Befehle…
command-ex-placeholder = Ex-Befehl eingeben…
palette-mode-ex = Ex
palette-mode-command = Befehle
palette-mode-slash = Befehl
palette-mode-path = Dateien
ex-write = Datei speichern
ex-write-quit = Speichern und schließen
ex-quit = Ohne Speichern schließen
ex-quit-force = Schließen und Änderungen verwerfen
ex-nohighlight = Suchhervorhebung aufheben
ex-delete = Zeile löschen
ex-yank = Zeile kopieren
ex-substitute = In der Zeile ersetzen
...
common-collapse-all = Alles zuklappen
common-loading = Lädt…
common-error = Fehler
...
command-browser-open-goto-line = Browser > Leiste > Gehe zu Zeile
command-browser-open-indentation = Browser > Leiste > Einrückung auswählen
command-browser-open-line-ending = Browser > Leiste > Zeilenende auswählen
command-browser-open-encoding = Browser > Leiste > Codierung auswählen
command-browser-open-reopen-with-encoding = Browser > Leiste > Mit Codierung erneut öffnen
command-browser-open-save-with-encoding = Browser > Leiste > Mit Codierung speichern
...
agent-tool-calls = { $count ->
    [one] { $count } Werkzeugaufruf
   *[other] { $count } Werkzeugaufrufe
}
...
agent-option-default = { $value } (Standard)
agent-tool-calling = Werkzeug wird aufgerufen
...
editor-status-goto-title = Gehe zu Zeile
editor-status-goto-placeholder = Zeilennummer
editor-status-pick-placeholder = Zum Filtern tippen
editor-status-indent-title = Einzug auswählen
editor-status-eol-title = Zeilenendezeichen auswählen
editor-status-encoding-title = Codierung auswählen
editor-status-encoding-reopen = Mit Codierung erneut öffnen
editor-status-encoding-save = Mit Codierung speichern
...
editor-find-case = Groß-/Kleinschreibung beachten
editor-find-in-files-placeholder = In Dateien suchen
editor-find-whole-word = Nur ganzes Wort
editor-search = Suche
editor-search-clear = Suchergebnisse löschen
editor-search-idle = Zum Suchen Eingabetaste drücken
editor-search-summary = { $results } Ergebnisse in { $files } Dateien
editor-search-summary-capped = Erste { $results } Ergebnisse in { $files } Dateien
editor-show-explorer = Explorer anzeigen
editor-show-search = Suche anzeigen
...
editor-explorer-empty = Keine Dateien
editor-open-editors = Geöffnete Editoren
editor-close-editor = Editor schließen
editor-outline = Gliederung
editor-close-directory = Verzeichnis schließen
editor-breadcrumb = Brotkrumen
editor-breadcrumb-hidden = Ausgeblendete Ordner anzeigen
editor-breadcrumb-empty = Nichts vorhanden
...
editor-rename-failed = Umbenennen fehlgeschlagen
...
git-stage-file = Datei stagen
git-unstage = Aus Stage entfernen
git-confirm-discard = Verwerfen bestätigen
git-discard-file = Änderungen verwerfen
git-commit-message = Commit-Nachricht
git-commit = Commit ({ $count })
git-push = ↑ Push
git-loading-diff = Diff wird geladen…
git-no-changes = Keine Änderungen anzuzeigen
git-stage-hunk = Block stagen
git-revert-hunk = Block zurücksetzen
...
resume-column-branch = Branch
resume-column-updated = Aktualisiert
resume-age-now = jetzt
resume-age-minutes = { $count } Min.
resume-age-hours = { $count } Std.
resume-age-days = { $count } T.
resume-age-weeks = { $count } Wo.
resume-age-months = { $count } Mon.
resume-age-years = { $count } J.
