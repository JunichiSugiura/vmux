...
mcp-command-description = Gerenciar servidores MCP
mcp-linear-description = Problemas, projetos e equipes
...
simulator-keyboard-placeholder = Digite ou cole no iPhone
simulator-copy = Copiar
simulator-paste = Colar
...
composer-project = Projeto
composer-branch = Branch
composer-attach-files = Anexar arquivos (/upload)
composer-remove-attachment = Remover anexo
composer-choose-agent = Escolher agente
composer-create-worktree = + Worktree
composer-create-worktree-title = Criar ou selecionar um worktree para este projeto
composer-status-running = Em execução
composer-status-approval = Aprovação
composer-status-starting = Iniciando
composer-status-error = Erro
composer-status-subagents = Subagentes ativos
composer-status-tasks-title = Tarefas abertas
composer-status-tasks = { $count } tarefas
composer-status-queued-title = Prompts na fila
composer-status-queued = { $count } na fila
composer-uncommitted-changes = Alterações não confirmadas
composer-commits-ahead = Commits à frente do upstream
composer-no-git = Sem Git
composer-git = Git
composer-git-repository = Repositório Git
...
command-partial-index = Apenas parte deste projeto foi indexada
command-more-matches = Mostrando {$shown} de {$total} correspondências
...
ex-quit = Fechar sem salvar
ex-quit-force = Fechar e descartar as alterações
ex-nohighlight = Limpar o destaque da busca
ex-delete = Excluir a linha
ex-yank = Copiar a linha
ex-substitute = Substituir na linha
...
common-collapse-all = Recolher tudo
...
command-browser-open-goto-line = Navegador > Barra > Ir para a linha
command-browser-open-indentation = Navegador > Barra > Selecionar recuo
command-browser-open-line-ending = Navegador > Barra > Selecionar fim de linha
command-browser-open-encoding = Navegador > Barra > Selecionar codificação
command-browser-open-reopen-with-encoding = Navegador > Barra > Reabrir com codificação
command-browser-open-save-with-encoding = Navegador > Barra > Salvar com codificação
...
agent-option-default = { $value } (padrão)
agent-tool-calling = Chamando ferramenta
...
editor-status-spaces = Espaços: { $width }
editor-status-tabs = Tabulação: { $width }
editor-status-goto-title = Ir para a linha
editor-status-goto-placeholder = Número da linha
editor-status-pick-placeholder = Digite para filtrar
editor-status-indent-title = Selecionar recuo
editor-status-eol-title = Selecionar sequência de fim de linha
editor-status-encoding-title = Selecionar codificação
editor-status-encoding-reopen = Reabrir com codificação
editor-status-encoding-save = Salvar com codificação
...
editor-find-case = Diferenciar maiúsculas de minúsculas
editor-find-in-files-placeholder = Buscar nos arquivos
editor-find-whole-word = Palavra inteira
editor-search = Pesquisar
editor-search-clear = Limpar resultados da pesquisa
editor-search-idle = Pressione Enter para pesquisar
editor-search-summary = { $results } resultados em { $files } arquivos
editor-search-summary-capped = Primeiros { $results } resultados em { $files } arquivos
editor-show-explorer = Mostrar explorador
editor-show-search = Mostrar pesquisa
...
editor-explorer-empty = Nenhum arquivo
editor-open-editors = Editores abertos
editor-close-editor = Fechar editor
editor-outline = Estrutura
editor-close-directory = Fechar o diretório
editor-breadcrumb = Trilha de navegação
editor-breadcrumb-hidden = Mostrar pastas ocultas
editor-breadcrumb-empty = Nada aqui
...
editor-rename-failed = Falha ao renomear
...
git-stage-file = Preparar arquivo
git-unstage = Remover do stage
git-confirm-discard = Confirmar descarte
git-discard-file = Descartar alterações
git-commit-message = mensagem de commit
git-commit = Commit ({ $count })
git-push = ↑ Push
git-loading-diff = Carregando diff…
git-no-changes = Nenhuma alteração para mostrar
git-stage-hunk = Preparar bloco
git-revert-hunk = Reverter bloco
...
agent-project-branch-change = Alterações em relação à branch base
agent-project-create-worktree = Criar um worktree nesta branch
resume-column-agent = Agente
resume-column-project = Projeto
resume-column-branch = Branch
resume-column-updated = Atualizado
resume-age-now = agora
resume-age-minutes = { $count } min
resume-age-hours = { $count } h
resume-age-days = { $count } d
resume-age-weeks = { $count } sem
resume-age-months = { $count } mes
