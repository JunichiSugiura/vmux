...
mcp-command-description = MCP-servers beheren
mcp-linear-description = Issues, projecten en teams
...
composer-choose-agent = Agent kiezen
composer-create-worktree = + Worktree
composer-create-worktree-title = Een worktree voor dit project maken of kiezen
composer-status-running = Actief
composer-status-approval = Goedkeuring
composer-status-starting = Starten
composer-status-error = Fout
composer-status-subagents = Actieve subagents
composer-status-tasks-title = Openstaande taken
composer-status-tasks = { $count } taken
composer-status-queued-title = Prompts in wachtrij
composer-status-queued = { $count } in wachtrij
composer-uncommitted-changes = Niet-vastgelegde wijzigingen
composer-commits-ahead = Commits voor op upstream
composer-no-git = Geen Git
composer-git = Git
...
command-partial-index = Slechts een deel van dit project is geïndexeerd
command-more-matches = {$shown} van {$total} overeenkomsten weergegeven
...
ex-quit = Sluiten zonder opslaan
ex-quit-force = Sluiten en wijzigingen verwerpen
ex-nohighlight = Zoekmarkering wissen
ex-delete = Regel verwijderen
ex-yank = Regel kopiëren
ex-substitute = Vervangen in de regel
...
command-browser-open-goto-line = Browser > Balk > Ga naar regel
command-browser-open-indentation = Browser > Balk > Inspringing selecteren
command-browser-open-line-ending = Browser > Balk > Regeleinde selecteren
command-browser-open-encoding = Browser > Balk > Codering selecteren
command-browser-open-reopen-with-encoding = Browser > Balk > Opnieuw openen met codering
command-browser-open-save-with-encoding = Browser > Balk > Opslaan met codering
...
agent-tool-calls = { $count ->
    [one] { $count } toolaanroep
   *[other] { $count } toolaanroepen
}
...
agent-option-default = { $value } (standaard)
agent-tool-calling = Tool wordt aangeroepen
...
editor-status-goto-title = Ga naar regel
editor-status-goto-placeholder = Regelnummer
editor-status-pick-placeholder = Typ om te filteren
editor-status-indent-title = Inspringing selecteren
editor-status-eol-title = Regeleindeteken selecteren
editor-status-encoding-title = Codering selecteren
editor-status-encoding-reopen = Opnieuw openen met codering
editor-status-encoding-save = Opslaan met codering
...
editor-find-case = Hoofdlettergevoelig
editor-find-in-files-placeholder = In bestanden zoeken
editor-find-whole-word = Heel woord
editor-search = Zoeken
editor-search-clear = Zoekresultaten wissen
editor-search-idle = Druk op Enter om te zoeken
editor-search-summary = { $results } resultaten in { $files } bestanden
editor-search-summary-capped = Eerste { $results } resultaten in { $files } bestanden
editor-show-explorer = Verkenner tonen
editor-show-search = Zoeken tonen
...
editor-explorer-empty = Geen bestanden
editor-open-editors = Open editors
editor-close-editor = Editor sluiten
editor-outline = Overzicht
editor-close-directory = Map sluiten
editor-breadcrumb = Kruimelpad
editor-breadcrumb-hidden = Verborgen mappen tonen
editor-breadcrumb-empty = Niets hier
...
editor-rename-failed = Hernoemen mislukt
...
git-unstage = Unstage
git-confirm-discard = Verwerpen bevestigen
git-discard-file = Wijzigingen verwerpen
...
resume-column-project = Project
resume-column-branch = Branch
resume-column-updated = Bijgewerkt
resume-age-now = nu
resume-age-minutes = { $count } min
resume-age-hours = { $count } u
resume-age-days = { $count } d
resume-age-weeks = { $count } w
resume-age-months = { $count } mnd
